...
public class principal extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "desof.appbase.test", "desof.appbase.test.principal");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "desof.appbase.test", "desof.appbase.test.principal");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "desof.appbase.test.principal", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Activity.LoadLayout(\"Main\")			'<< CARGAMOS EL LAY";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="If Funciones.LOGUEADO=False Then btnSignOut.Enabl";
if (mostCurrent._funciones._logueado==anywheresoftware.b4a.keywords.Common.False) { 
mostCurrent._btnsignout.setEnabled(anywheresoftware.b4a.keywords.Common.False);};
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public static String  _btnsignout_click() throws Exception{
 //BA.debugLineNum = 31;BA.debugLine="Sub btnSignOut_Click";
 //BA.debugLineNum = 32;BA.debugLine="btnSignOut.Enabled=False";
mostCurrent._btnsignout.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 33;BA.debugLine="Starter.auth.SignOutFromGoogle";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 12;BA.debugLine="Private btnSignOut As Button";
